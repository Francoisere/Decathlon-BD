...
oci_execute($stmt_tipos_contrato);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$id_contrato) {
        die("Error al obtener el siguiente valor de la secuencia.");
    }
    ...
    if (oci_execute($stmt_insert)) {
        ...
        $query_insert_usuario = "INSERT INTO JS_FS_FV_VV_Usuario 
                                 (RUT_USUARIO, NOMBRE1, NOMBRE2, APELLIDO1, APELLIDO2, CLAVE,TELEFONO, SALARIO, ID_CARGO, ID_CONTRATO, ID_PREVISION, ID_CC, CORREO) 
                                 VALUES 
                                 (:RUT_USUARIO, :NOMBRE1, :NOMBRE2, :APELLIDO1, :APELLIDO2, JS_FS_FV_VV_GENERA_CLAVE(:NOMBRE1, :APELLIDO1), JS_FS_FV_VV_GENERA_TELEFONO, :SALARIO, :ID_CARGO, :ID_CONTRATO, 1, 1, 
                                 JS_FS_FV_VV_GENERA_CORREO(:NOMBRE1, :APELLIDO1, :APELLIDO2))";
