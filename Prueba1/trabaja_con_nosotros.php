...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query_check = "SELECT COUNT(*) AS EXISTE FROM JS_FS_FV_VV_CANDIDATO 
        ...
        if ($curriculum['error'] === UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($curriculum['tmp_name'], $curriculum_path)) {
                ...
                $query = "INSERT INTO JS_FS_FV_VV_CANDIDATO 
                          (Nombre1, Nombre2, Apellido1, Apellido2, RUT_CANDIDATO, Fecha_Nacimiento, Deporte_interes, Cargo_Postular, Curriculum) 
                          VALUES (:nombre1, :nombre2, :apellido1, :apellido2, :rut, TO_DATE(:fecha_nacimiento, 'YYYY-MM-DD'), :deporte, :cargo_postular, :curriculum_path)";
